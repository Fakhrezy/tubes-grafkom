...
pygame.display.set_caption("Tempat Pemakaman Umum")
...
def load_jurig(jurig_image):
    ...
    # Sesuaikan ukuran gambar sesuai kebutuhan
    jurig = pygame.transform.scale(jurig, (100, 100))  # Ganti ukuran
    return jurig
...
def load_bulan(bulan_image):
    ...
    # Sesuaikan ukuran gambar sesuai kebutuhan
    bulan = pygame.transform.scale(bulan, (200, 200))  # Ganti ukuran
    return bulan
...
def game_loop():
    ...
    # JURIG GERAK
    jurig_speed = 0  # Kecepatan 0 untuk berhenti
    ...
    while True:
        ...
        screen.blit(bintang, (450, 130))
        screen.blit(bintang, (350, 40))
        screen.blit(pocong, (200, 300))
        
        
        # # TRANSLASI POCONG LONCAT ke atas dan ke bawah 
        ...
        angle += 0  # Ubah sesuai kecepatan rotasi yang diinginkan
